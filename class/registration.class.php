...
class RegistrationCore
{
	...
	public static function defaultSettings()
	{
		return array(
			...
			/* Шилэн (glass) загвар — Apple маягийн тунгалаг хайрцгууд.
			   Мэдээллийн хайрцаг, бүртгэлийн форм, input-д үйлчилнэ. */
			"themeGlass"      => "1",
			"themeGlassTint"  => "10",   /* хайрцгийн сүүлэг байдал 0-100 */
			"themeGlassInput" => "72",   /* input-ийн сүүлэг байдал 0-100 */
			"themeGlassBlur"  => "22",   /* бүдгэрүүлэлт px */
		...
		return array(
			...
			"agenda" => array(
				...
				"cols"  => array(
					...
					/* Coming soon — асаавал хөтөлбөрийн оронд бүтэн дэлгэц
					   "тун удахгүй" харагдана. Унтраавал хөтөлбөр нь
					   хэвээрээ буцаж ирнэ (агуулга устдаггүй). */
					array("key" => "soon",      "name" => "Coming soon болгох", "type" => "bool",
						"help" => "Асаавал хөтөлбөрийн оронд \"тун удахгүй\" гэсэн дэлгэц харагдана. Бичсэн хөтөлбөр устахгүй."),
					array("key" => "soonTitle", "name" => "Coming soon гарчиг",  "type" => "text", "def" => "Тун удахгүй"),
					array("key" => "soonText",  "name" => "Coming soon тайлбар", "type" => "textarea",
						"def" => "Өдөрлөгийн дэлгэрэнгүй хөтөлбөрийг удахгүй энд нийтэлнэ."),
