...
define('CACHE_DIR_NAME',		'/postpic/cache/');
...
switch($_REQUEST["imgDir"]){
	case 1:
		...
		if(!file_exists($docRoot .$path . $image))
			$image = "def.jpg";
