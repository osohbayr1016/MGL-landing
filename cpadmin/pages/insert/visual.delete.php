<div class="modal-dialog modal-md">
	<div class="modal-content animated bounceInRight">
        <div class="modal-header">
            ...
            <div class="modal-title">Visualisation устгах</div>
        </div>
        ...
        <div class="modal-body">
			...
			if($isDelete){
				?>
            Та <strong><?php echo $selNewObj["visualTitle"]?></strong> нэртэй Visualisation устгахдаа итгэлтэй байна уу
            <?php
			}
			else{
			?>
        ...
        <div class="modal-footer">
            <input type="hidden" name="frmPost" value="visualDel" />
