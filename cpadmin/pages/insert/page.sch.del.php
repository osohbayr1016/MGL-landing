<div class="modal-dialog modal-md">
	<div class="modal-content animated bounceInRight">
        <div class="modal-header">
            ...
            <div class="modal-title">Хуудасны туслах агуулга устгах</div>
        </div>
        ...
        <div class="modal-body">
			...
			if($isDelete){
				?>
            Та <strong><?php echo $selTypeObj["schTitle"]?></strong> агуулгыг устгахдаа итгэлтэй байна уу
            <?php
			}
			else{
			?>
        ...
        <div class="modal-footer">
            <input type="hidden" name="frmPost" value="schPageDel" />
