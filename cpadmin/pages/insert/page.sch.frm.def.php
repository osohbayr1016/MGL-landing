           ...
           <div class="row">
            	<div class="col-lg-6">
                    <label class="font-noraml">Холбоос</label><br />
                    <div >
						<input type="text" class="form-control input-sm" name="frmLink" value="<?php echo $selTypeObj["schLink"];?>">
					</div>
                </div> 
                <div class="col-lg-6">
                	<div class="form-group" >
                        ...
                        <div >
                            ...
                            <img height="100" src="<?php echo widPicFnc($selTypeObj["schPic"]);?>" />
                            <?php } ?>
                        </div>
                </div>
