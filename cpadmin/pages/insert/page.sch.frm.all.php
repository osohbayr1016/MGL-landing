...
case "radio":
    ?>
    <div class="form-group">
        <input class="form-check-input" name="frmVal[<?php echo $obj["colKey"]?>]" value="y" <?php if($selSchBody[$obj["colKey"]]=="y") echo "checked";?> type="checkbox" id="rd<?php echo $obj["colKey"]?>">
        <label class="form-check-label" for="rd<?php echo $obj["colKey"]?>"><?php echo $obj["colName"]?></label>
    </div>
    <?php 
    break;
case "file":
