...
<div class="modal-dialog modal-md">
	<div class="modal-content animated bounceInRight">
        ...
        <div class="modal-body">
			...
			if($isDelete){
				?>
            Та <strong><?php echo $selTypeObj["name"]?></strong> ангиллыг устгахдаа итгэлтэй байна уу
            <?php
			}
			else{
			?>
           <div class="alert alert-danger" role="alert"><strong><?php echo $selTypeObj["name"]?></strong> ангиллыг устгах боломжгүй. Энэ ангилал дээр мэдээлэл оруулсан байна!</div>
           <?php } ?>
           
        </div>
        <div class="modal-footer">
            <input type="hidden" name="frmPost" value="typeDel" />
			<input name="frmDelID" type="hidden" value="<?php echo $selTypeID;?>" />
            <input type="hidden" name="frmMainType" value="<?php echo $selTypeObj["type"];?>" />
