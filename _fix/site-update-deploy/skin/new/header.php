                ...
                <div class="standard-menu">
                    <div id="header-menu" class="menu">
						<ul class="">
							...
							<a class="" target="_self" href="<?php echo $menuLink;?>"><?php echo menuNameFunc($obj)?></a>
							<?php
							if(count($obj["sub"])>0){
							?>
							<ul class="sub-menu">
								...
								?>
								<li >									
									<a href="<?php echo $menuLink?>" class="js-link-force_reload"><?php echo menuNameFunc($objs)?></a>									
								</li>
								<?php 
								}
								?>
                    ...
                    <div class="language-menu-inner">
						<ul class="">
							...
							foreach($allAllMenuArr as $key=>$obj){
								...
								$menuLink = menuLinkFunc($obj);
							?>
							<li id="menu-item-<?php echo $obj["id"]?>" class="menu-item"><a class="" target="_self" href="<?php echo $menuLink;?>"><?php echo menuNameFunc($obj)?></a></li>
                            <?php }} ?>
						</ul>
                    </div>
                </div>
