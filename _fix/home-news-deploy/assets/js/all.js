    ...
    news_carousel = {
        ...
        init: function() {
            ...
            e.owlCarousel({
                ...
                autoplaySpeed: 1200,
                smartSpeed: 1200,
                slideTransition: "cubic-bezier(0.33, 0, 0.2, 1)",
                slideBy: 1,
                rtl: !1,
                stagePadding: 0,
                responsiveClass: !0,
            ...
            var a;
            $(window).on("resize.newsCarousel", function() {
                clearTimeout(a), a = setTimeout(function() {
                    news_carousel.canAutoplay(i, news_carousel.getVisibleItems()) ? news_carousel.startAutoplay(e) : e.trigger("stop.owl.autoplay")
                }, 250)
            })
        }
    },
