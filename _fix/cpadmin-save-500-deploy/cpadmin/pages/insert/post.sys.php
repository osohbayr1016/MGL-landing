...
/* r2Store()/r2Remove() live in cpadmin/r2.php, normally loaded by
   config.php. Load it here as well so a partial upload of the admin panel
   can never turn an image save into a fatal "undefined function" 500. */
if(!function_exists("r2Store"))
	include_once dirname(dirname(__DIR__)) . "/r2.php";
...
switch($_POST["frmPost"]){
	...
	break;
	case "clientsSave":
		include "clients.save.php";
	break;
	case "clientUpload":
		include "clients.upload.php";
	break;
	case "visualPost":
