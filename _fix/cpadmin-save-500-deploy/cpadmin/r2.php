...
/*
	Copy a freshly uploaded file up to R2. The local copy is dropped only
	once $gloCdnBase is set, i.e. once the site really reads images through
	the Worker; until then it stays on disk so the pages keep showing it.
	A failed upload leaves the local file untouched either way.
*/
