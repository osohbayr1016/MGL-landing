...
.hp-slot{position:relative;flex:0 0 25%;max-width:25%;padding:0 10px 20px;box-sizing:border-box;cursor:pointer;}
...
.hp-placeholder{flex:0 0 25%;max-width:25%;padding:0 10px 20px;min-height:180px;background:#f3fcf9;border:1px dashed #1ab394;box-sizing:border-box;}
