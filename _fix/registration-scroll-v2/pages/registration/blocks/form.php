...
echo '<section id="registration-form" class="reg-section reg-form-section reg-scroll-section reg-scroll-section--fluid">';
echo '<div class="reg-section-bg" style="' . regScrollBgStyle($regData) . '"></div>';
echo '<div class="reg-scroll-content" style="' . regScrollPadStyle($regData, 80, 100) . '">';
?>
	<div class="reg-wrap">
